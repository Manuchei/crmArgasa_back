...
public class ClienteProductoService {
	...
	public ClienteProductoService(ProductoRepository productoRepo, ClienteRepository clienteRepo,
	...
	@Transactional
	public ClienteProducto addProductoCliente(Long clienteId, Long productoId, AddProductoRequest request,
			String empresa) {
		...
		// throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "El producto no
		// pertenece a la empresa del cliente");
		// }
