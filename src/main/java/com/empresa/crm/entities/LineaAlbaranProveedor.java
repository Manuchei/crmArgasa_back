...
@Data
@Entity
@Table(name = "lineas_albaran_proveedor")
public class LineaAlbaranProveedor {
	...
	// Para distinguir si la línea viene de TRABAJO o PRODUCTO
	@Column(length = 20)
	private String tipo;
	...
	@JsonBackReference("albaran-proveedor-lineas")
	private AlbaranProveedor albaran;
